...
_DISCOVERABLE_SERVICES: List[Dict[str, Any]] = [
    ...
    # ── New services ─────────────────────────────────────────────────────
    {
        ...
        "category": "hosting",
        "description": "Cloud infrastructure — deploy droplets, databases, and apps globally",
        "url": "https://www.digitalocean.com",
        "capabilities": ["deploy servers", "managed databases", "Kubernetes", "object storage", "app platform"],
        "skill_level": "intermediate",
        "use_cases": ["deploy", "hosting", "launch_startup", "build_project", "scale"],
    },
    {
        ...
        "capabilities": ["PostgreSQL database", "authentication", "file storage", "real-time", "edge functions"],
        "skill_level": "intermediate",
        "use_cases": ["build_project", "launch_startup", "saas", "prototype"],
    },
    {
        "service_name": "slack",
        "category": "messaging",
        "description": "Team messaging platform with rich app integrations",
        "url": "https://slack.com",
        "capabilities": ["team communication", "app integrations", "automation", "file sharing", "channels"],
        "skill_level": "beginner",
        "use_cases": ["team_communication", "automation", "notifications", "build_project"],
    },
    {
        "service_name": "shopify",
        "category": "e-commerce",
        "description": "All-in-one e-commerce platform — build and run your online store",
        "url": "https://shopify.com",
        "capabilities": ["sell products", "process payments", "manage inventory", "marketing", "analytics"],
        "skill_level": "beginner",
        "use_cases": ["sell_products", "make_money_online", "launch_startup", "e-commerce"],
    },
    {
        ...
        "capabilities": ["contact management", "deal tracking", "email marketing", "pipelines", "analytics"],
        "skill_level": "intermediate",
        "use_cases": ["sales", "marketing", "launch_startup", "crm"],
    },
    {
        "service_name": "resend",
        "category": "email",
        "description": "Developer-first transactional email API built for modern applications",
        "url": "https://resend.com",
        "capabilities": ["send transactional emails", "email templates", "domain management", "event tracking"],
        "skill_level": "intermediate",
        "use_cases": ["launch_startup", "saas", "transactional_email", "build_project"],
    },
]
