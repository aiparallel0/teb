...
const TableView = {
  ...
  render(tasks, container, options = {}) {
    ...
    if (!tasks || tasks.length === 0) {
      container.innerHTML = '<div class="empty-state-large"><div class="empty-state-icon"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg></div><div class="empty-state-title">Table View</div><div class="empty-state-desc">No tasks yet — add one above to see them in a sortable spreadsheet.</div></div>';
      return;
    }
