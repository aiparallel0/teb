...
const CalendarView = {
  ...
  render(tasks, container) {
    ...
    if (!tasks || tasks.length === 0) {
      container.innerHTML = '<div class="empty-state-large"><div class="empty-state-icon"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Calendar"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div><div class="empty-state-title">Calendar View</div><div class="empty-state-desc">Add due dates to tasks to see them on the calendar.</div></div>';
      return;
    }
